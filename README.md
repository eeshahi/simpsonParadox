...
comparison_plot <- (plot1 + plot2) +
  plot_annotation(
    title = "Simpson's Paradox: When Aggregated Data Tells a Different Story",
    subtitle = "Left: Overall relationship appears positive | Right: Within-species relationships are actually negative",
    caption = "This visualization demonstrates how Simpson's Paradox can completely reverse the apparent relationship between variables when we consider confounding factors (species in this case). The same data tells two completely different stories!",
...
![Simpson’s Paradox: The Power of Side-by-Side
Comparison](README_files/figure-commonmark/unnamed-chunk-3-1.png)
...
completely different stories depending on whether we consider the
grouping variable
