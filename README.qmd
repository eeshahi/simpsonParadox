...
#| message: false
#| warning: false
#| fig-cap: "Simpson's Paradox: The Power of Side-by-Side Comparison"
...
- **The paradox:** The same data tells two completely different stories depending on whether we consider the grouping variable
